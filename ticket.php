      ...
      <div class='card bg-dark '>
       ...
       <div class='row'>
         <div class='col-md-6'>
           ...
           <h4 class='text-white'> ID Card No :</h4>
...
<div id="results">
    ...
    <!-- Include JavaScript to handle the print functionality -->
    <script>
        // JavaScript code goes here
         // Function to handle the print button click
    function handlePrintButtonClick() {
        // Get the element with the ID "results"
        var resultsElement = document.getElementById('results');

        // Open the print dialog for the "results" element
        window.print();
    }
