...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">obrt@gmail.com</a>
        <i class="fa fa-phone"></i> +254 741649050
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto">South<span>LINE</span></a></h1>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      <h2>Making <span>your Ride</span><br>PERFECT!</h2>
      <div>
        <a href="profile.php" class="btn-get-started scrollto">BOOK A TICKET NOW!</a>
      </div>
    </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>SOUTHBOY</strong>. All Rights Reserved
      </div>
      <div class="credits">
       
        Designed by <a href="#">Godfrey Bahati</a>
      </div>
    </div>
  </footer><!-- #footer -->
