...
if (isset($_POST['signup'])) {
	...
	if (mysqli_num_rows($run)>0) {
		echo "<h4>USERNAME ALREADY EXIST PLEASE ENTER VALID USERNAME OR PLEASE SIGN UP</h4>";
	}else{
		$sql="INSERT INTO `user_info` (`uid`, `name`, `uname`, `age`, `ID_no`, `psw`, `email`)
		 VALUES (NULL, '$name', '$uname', '$age', '$ID_no', '$psw', '$email')";
		$run=mysqli_query($con,$sql);
		if($run){
